...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServingString'
        db.create_table(u'recipes_servingstring', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'recipes', ['ServingString'])

        # Adding field 'Recipe.serving_string'
        db.add_column(u'recipes_recipe', 'serving_string',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.ServingString'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Recipe.serving_value'
        db.add_column(u'recipes_recipe', 'serving_value',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ServingString'
        db.delete_table(u'recipes_servingstring')

        # Deleting field 'Recipe.serving_string'
        db.delete_column(u'recipes_recipe', 'serving_string_id')

        # Deleting field 'Recipe.serving_value'
        db.delete_column(u'recipes_recipe', 'serving_value')
    ...
    models = {
        ...
        u'recipes.recipe': {
            ...
            'serving_value': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
