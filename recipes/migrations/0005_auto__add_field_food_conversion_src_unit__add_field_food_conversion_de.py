...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Food.conversion_src_unit'
        db.add_column(u'recipes_food', 'conversion_src_unit',
        ...
        # Adding field 'Food.conversion_factor'
        db.add_column(u'recipes_food', 'conversion_factor',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Food.conversion_src_unit'
        db.delete_column(u'recipes_food', 'conversion_src_unit_id')

        # Deleting field 'Food.conversion_dest_unit'
        db.delete_column(u'recipes_food', 'conversion_dest_unit_id')

        # Deleting field 'Food.conversion_factor'
        db.delete_column(u'recipes_food', 'conversion_factor')
    ...
    models = {
        ...
        u'recipes.food': {
            ...
            'conversion_dest_unit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['recipes.Unit']"}),
