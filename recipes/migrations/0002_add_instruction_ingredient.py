...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.ctime'
        db.alter_column('recipes_recipe', 'ctime', models.DateTimeField(auto_now_add=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Ingredient.instruction'
        db.delete_column('recipes_ingredient', 'instruction')
        
        # Changing field 'Recipe.mtime'
        db.alter_column('recipes_recipe', 'mtime', models.DateTimeField())
        
        # Changing field 'Recipe.ctime'
        db.alter_column('recipes_recipe', 'ctime', models.DateTimeField(default=datetime.datetime.now))
