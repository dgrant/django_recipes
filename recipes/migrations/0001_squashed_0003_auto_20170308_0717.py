...
class Migration(migrations.Migration):
    replaces = [('recipes', '0001_initial'), ('recipes', '0002_auto_20140904_2053'),
                ('recipes', '0003_auto_20170308_0717')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredients',
                                                to='recipes.Direction')),
        ...
        migrations.AddField(
            ...
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='directions',
                                    to='recipes.Recipe'),
        ),
        migrations.AlterField(
            ...
            name='direction',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                    related_name='ingredients', to='recipes.Direction'),
        ),
        ...
        migrations.AlterModelOptions(
            name='ingredient',
            options={'ordering': ['direction', 'order_index', 'id'], 'verbose_name': 'Ingredient',
