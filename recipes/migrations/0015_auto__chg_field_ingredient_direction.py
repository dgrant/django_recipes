...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ingredient.direction'
        db.alter_column(u'recipes_ingredient', 'direction_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['recipes.Direction']))

    def backwards(self, orm):

        # Changing field 'Ingredient.direction'
        db.alter_column(u'recipes_ingredient', 'direction_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['recipes.Direction']))
    ...
    models = {
        ...
        u'recipes.ingredient': {
            ...
            'direction': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ingredients'", 'to': u"orm['recipes.Direction']"}),
