...
MEDIA_ROOT = os.path.join(ROOT, 'recipes_media')
...
STATIC_ROOT = os.path.abspath(os.path.join(ROOT, '..', '..', 'django-recipes-static'))

# URL prefix for static files.
# Example: "http://media.lawrence.com/static/"
STATIC_URL = '/recipes_media/'
...
#    # Don't forget to use absolute paths, not relative paths.
    os.path.abspath(os.path.join(ROOT, '..', 'recipes_media')),
)
